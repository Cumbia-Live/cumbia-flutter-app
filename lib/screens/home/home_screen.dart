      ...
      if (querySnapshot.docs.isNotEmpty) {
        ...
        querySnapshot.docs.forEach((merchantStream) {
          ...
          LogMessage.get(References.users.firestore
              .collection(merchantStream.data()["userId"])
              .toString());
          References.users
            ...
            if (userDoc.data().isNotEmpty) {
              lstTiendas.add(
                Merchant(
                    ...
                    colombianProducts:
                        merchantStream.data()["colombianProducts"],
                    ...
                    storeLocation: Address(
                      address: merchantStream.data()['storeLocation'] != null
                          ? merchantStream.data()['storeLocation']['address']
                          : "",
                      city: merchantStream.data()['storeLocation'] != null
                          ? merchantStream.data()['storeLocation']['city']
                          : "",
                      country: merchantStream.data()['storeLocation'] != null
                          ? merchantStream.data()['storeLocation']['country']
                          : "",
                      state: merchantStream.data()['storeLocation'] != null
                          ? merchantStream.data()['storeLocation']['state']
                          : "",
                    )),
              );
              lstTiendasCategoria.clear();
