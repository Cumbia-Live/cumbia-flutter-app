              ...
              await References.products
                  ...
                  .then((element) => {
                        p = new Product(
                          ...
                          imageUrl: (element.data()['productInfo']
                                          ['imageUrl'] !=
                                      '' &&
                          ...
                          productName: element.data()['productInfo']
                                  ['productName'] ??
                              '',
                          description: element.data()['productInfo']
                                  ['description'] ??
                              '',
                          reference:
                              element.data()['productInfo']['reference'] ?? '',
                          height: double.parse(element
                                  .data()['especifications']['height']
                                  .toString()) ??
                              '',
                          large: double.parse(element
                                  .data()['especifications']['large']
                                  .toString()) ??
                              '',
                          width: double.parse(element
                                  .data()['especifications']['width']
                                  .toString()) ??
                              '',
                          weight: double.parse(element
                                  .data()['especifications']['weight']
                                  .toString()) ??
                              '',
                          avaliableUnits:
                              element.data()['avaliableUnits'] ?? '',
                          price: element.data()['price'] ?? '',
                          color: element.data()['variantInfo']['color'] ?? '',
                          size: element.data()['variantInfo']['size'] ?? '',
                          isFreeShipping:
                              element.data()['isFreeShipping'] ?? false,
                          isShipmentRequired:
                              element.data()['isShipmentRequired'] ?? true,
                        )
                      })
                  .then((value) async {
